...
const appAPI = axios.create({
  baseURL: "https://app01-24732-prod.herokuapp.com/",
...
function api_v1_customtext_read(action) {
  return appAPI.get(`/api/v1/customtext/${action.id}/`)
}
function api_v1_customtext_update(action) {
  return appAPI.put(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_customtext_partial_update(action) {
  return appAPI.patch(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_homepage_read(action) {
  return appAPI.get(`/api/v1/homepage/${action.id}/`)
}
function api_v1_homepage_update(action) {
  return appAPI.put(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_homepage_partial_update(action) {
  return appAPI.patch(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_signup_create(action) {
  return appAPI.post(`/api/v1/signup/`, null, { data: action.data })
}
function rest_auth_login_create(action) {
  return appAPI.post(`/rest-auth/login/`, null, { data: action.data })
}
...
function rest_auth_password_change_create(action) {
  return appAPI.post(`/rest-auth/password/change/`, null, { data: action.data })
}
function rest_auth_password_reset_create(action) {
  return appAPI.post(`/rest-auth/password/reset/`, null, { data: action.data })
}
function rest_auth_password_reset_confirm_create(action) {
  return appAPI.post(`/rest-auth/password/reset/confirm/`, null, {
    data: action.data
  })
}
function rest_auth_registration_create(action) {
  return appAPI.post(`/rest-auth/registration/`, null, { data: action.data })
}
function rest_auth_registration_verify_email_create(action) {
  return appAPI.post(`/rest-auth/registration/verify-email/`, null, {
    data: action.data
  })
}
...
function rest_auth_user_update(action) {
  return appAPI.put(`/rest-auth/user/`, null, { data: action.data })
}
function rest_auth_user_partial_update(action) {
  return appAPI.patch(`/rest-auth/user/`, null, { data: action.data })
}
